...
$(document).ready(function() {
    ...
    function(a) {
        a.fn.appTable = function(t) {
            var e = {
                ...
                n = a(this);
            if (!n.is("table")) return console.log("Element must have to be a table", this), !1;
            var r = a.extend({}, e, t);
            if (r.reload) {
                var o = a(this).dataTable(),
                    i = window.InstanceCollection[a(this).selector];
                return i || (i = r), o.fnReloadAjax(i.filterParams), !1
            }
            if (r.newData) {
                var o = a(this).dataTable();
                if (r.dataId) {
                    var s = a(this).find("[data-post-id='" + r.dataId + "']");
                    if (s.length) o.fnDeleteRow(s.closest("tr"));
                    else {
                        var l = a(this).find("[data-index-id='" + r.dataId + "']");
                        l.length && o.fnDeleteRow(l.closest("tr"))
                    }
                }
                return o.fnAddRow(r.newData), !1
            }
            r._visible_columns = [], a.each(r.columns, function(a, t) {
                t.visible !== !1 && r._visible_columns.push(a)
            }), r._exportable = r.xlsColumns.length + r.pdfColumns.length + r.printColumns.length, r._firstDayOfWeek = AppHelper.settings.firstDayOfWeek || 0, r._inputDateFormat = "YYYY-MM-DD";
            var d = function(a) {
                ...
                c = function() {
                    if ("daily" === r.dateRangeType) r.filterParams.start_date = moment().format(r._inputDateFormat), r.filterParams.end_date = r.filterParams.start_date;
                    else if ("monthly" === r.dateRangeType) {
                        var a = moment().daysInMonth(),
                            t = moment().format("YYYY-MM");
                        r.filterParams.start_date = t + "-01", r.filterParams.end_date = t + "-" + a
                    } else if ("yearly" === r.dateRangeType) {
                        var e = moment().format("YYYY");
                        r.filterParams.start_date = e + "-01-01", r.filterParams.end_date = e + "-12-31"
                    } else if ("weekly" === r.dateRangeType) {
                        var n = d();
                        r.filterParams.start_date = n.firstDateOfWeek, r.filterParams.end_date = n.lastDateOfWeek
                    }
                },
                m = function() {
                    var t = [],
                        e = "";
                    a.each(r.checkBoxes, function(a, n) {
                        e = n.name, n.isChecked && t.push(n.value)
                    }), r.filterParams[e] = t
                },
                f = function() {
                    a.each(r.radioButtons, function(a, t) {
                        t.isChecked && (r.filterParams[t.name] = t.value)
                    })
                };
            c(), m(), f();
            var u = {
                ...
                columns: r.columns,
                bProcessing: !0,
                iDisplayLength: r.displayLength,
                bAutoWidth: !1,
                bSortClasses: !1,
                order: r.order,
                fnInitComplete: function() {
                    r.onInitComplete(this)
                },
                language: {
                ...
                sDom: "",
                footerCallback: function(t, e, n, o, i) {
                    var s = this;
                    if (r.summation) {
                        var l = s.api().page.info();
                        if (!l.recordsTotal) return a(s).find("tfoot").hide(), !1;
                        a(s).find("tfoot").show(), a.each(r.summation, function(t, e) {
                    ...
                    r.footerCallback(t, e, n, o, i, s)
                },
                fnRowCallback: function(a, t, e, n) {
                    r.rowCallback(a, t, e, n)
                }
            };
            if (r.hideTools || (u.sDom = "<'datatable-tools'<'col-md-3'l><'col-md-9 custom-toolbar'f>r>t<'datatable-tools clearfix'<'col-md-3'i><'col-md-9'p>>"), r._exportable) {
                var p = [];
                if (r.xlsColumns.length && p.push({
                        sExtends: "xls",
                        mColumns: r.xlsColumns
                    }), r.pdfColumns.length && p.push({
                        sExtends: "pdf",
                        mColumns: r.pdfColumns
                    }), r.printColumns.length) {
                    var h = function(a, t) {
                        return a.filter(function(a) {
                            return t.indexOf(a) < 0
                        })
                    };
                    r._hiddenColumns = h(r._visible_columns, r.printColumns), p.push({
                        sExtends: "print",
                        sToolTip: r.customLanguage.printButtonToolTip,
                        sInfo: "",
                        fnClick: function(t, e) {
                            for (var n in r._hiddenColumns) g.fnSetColumnVis(r._hiddenColumns[n], !1);
                            a("html").addClass("print-peview"), a(".slimScrollDiv").addClass("print-peview"), a(".scrollable-page").addClass("print-peview"), this.fnPrint(!0, e), a(window).keydown(function(t) {
                                if (27 === t.which) {
                                    for (var e in r._hiddenColumns) g.fnSetColumnVis(r._hiddenColumns[e], !0);
                ...
                r.hideTools || (u.sDom = "<'datatable-tools'<'col-md-3'l><'col-md-9 custom-toolbar'f<'datatable-export'T>>r>t<'datatable-tools clearfix'<'col-md-3'i><'col-md-9'p>>"), u.oTableTools = {
                    aButtons: p
                }
            }
            var g = n.dataTable(u),
                v = n.closest(".dataTables_wrapper");
            if (v.find(".DTTT_button_print").tooltip({
                    placement: "bottom",
                    container: "body"
                }), v.find("select").select2({
                    minimumResultsForSearch: -1
                }), r.dateRangeType) {
                var b = '<div class="mr15 DTTT_container"><button data-act="prev" class="btn btn-default date-range-selector"><i class="fa fa-chevron-left"></i></button><button data-act="datepicker" class="btn btn-default" style="margin: -1px"></button><button data-act="next"  class="btn btn-default date-range-selector"><i class="fa fa-chevron-right"></i></button></div>';
                v.find(".custom-toolbar").append(b);
                var y = v.find("[data-act='datepicker']"),
                    _ = v.find(".date-range-selector");
                if ("daily" === r.dateRangeType) {
                    var T = function(a) {
                        r.filterParams.start_date === moment().format(r._inputDateFormat) ? a.html(r.customLanguage.today) : r.filterParams.start_date === moment().subtract(1, "days").format(r._inputDateFormat) ? a.html(r.customLanguage.yesterday) : r.filterParams.start_date === moment().add(1, "days").format(r._inputDateFormat) ? a.html(r.customLanguage.tomorrow) : a.html(moment(r.filterParams.start_date).format("Do, MMMM YYYY"))
                    };
                    c(), T(y), y.datepicker({
                        format: r._inputDateFormat,
                        autoclose: !0,
                        todayHighlight: !0
                    }).on("changeDate", function(a) {
                        var t = moment(a.date).format(r._inputDateFormat);
                        r.filterParams.start_date = t, r.filterParams.end_date = t, T(y), n.appTable({
                            reload: !0,
                        ...
                        var t = a(this).attr("data-act"),
                            e = "";
                        "next" === t ? e = moment(r.filterParams.start_date).add(1, "days").format(r._inputDateFormat) : "prev" === t && (e = moment(r.filterParams.start_date).subtract(1, "days").format(r._inputDateFormat)), r.filterParams.start_date = e, r.filterParams.end_date = e, T(y), n.appTable({
                            reload: !0,
                            filterParams: r.filterParams
                        })
                    })
                }
                if ("monthly" === r.dateRangeType) {
                    var x = function(a) {
                        a.html(moment(r.filterParams.start_date).format("MMMM YYYY"))
                    };
                    c(), x(y), y.datepicker({
                        format: "YYYY-MM",
                        viewMode: "months",
                        ...
                        var t = moment(a.date).format(r._inputDateFormat),
                            ...
                            o = moment(t).format("YYYY-MM");
                        r.filterParams.start_date = o + "-01", r.filterParams.end_date = o + "-" + e, x(y), n.appTable({
                            reload: !0,
                            filterParams: r.filterParams
                        })
                    }), _.click(function() {
                        var t = a(this).attr("data-act"),
                            e = moment(r.filterParams.start_date),
                            o = moment(r.filterParams.end_date);
                        "next" === t ? (e = e.add(1, "months").format(r._inputDateFormat), o = o.add(1, "months").format(r._inputDateFormat)) : "prev" === t && (e = e.subtract(1, "months").format(r._inputDateFormat), o = o.subtract(1, "months").format(r._inputDateFormat)), r.filterParams.start_date = e, r.filterParams.end_date = o, x(y), n.appTable({
                            reload: !0,
                            filterParams: r.filterParams
                        })
                    })
                }
                if ("yearly" === r.dateRangeType) {
                    var D = function(a) {
                        a.html(moment(r.filterParams.start_date).format("YYYY"))
                    };
                    c(), D(y), y.datepicker({
                        format: "YYYY-MM",
                        viewMode: "years",
                        ...
                        r.filterParams.start_date = e + "-01-01", r.filterParams.end_date = e + "-12-31", D(y), n.appTable({
                            reload: !0,
                            filterParams: r.filterParams
                        })
                    }), _.click(function() {
                        var t = a(this).attr("data-act"),
                            e = moment(r.filterParams.start_date),
                            o = moment(r.filterParams.end_date);
                        "next" === t ? (e = e.add(1, "years").format(r._inputDateFormat), o = o.add(1, "years").format(r._inputDateFormat)) : "prev" === t && (e = e.subtract(1, "years").format(r._inputDateFormat), o = o.subtract(1, "years").format(r._inputDateFormat)), r.filterParams.start_date = e, r.filterParams.end_date = o, D(y), n.appTable({
                            reload: !0,
                            filterParams: r.filterParams
                        })
                    })
                }
                if ("weekly" === r.dateRangeType) {
                    var w = function(a) {
                        var t = moment(r.filterParams.start_date).format("Do MMM"),
                            e = moment(r.filterParams.end_date).format("Do MMM, YYYY");
                        y.datepicker({
                            format: "YYYY-MM-DD",
                            autoclose: !0,
                            calendarWeeks: !0,
                    ...
                    c(), w(y), _.click(function() {
                        var t = a(this).attr("data-act"),
                            e = moment(r.filterParams.start_date),
                            o = moment(r.filterParams.end_date);
                        "next" === t ? (e = e.add(7, "days").format(r._inputDateFormat), o = o.add(7, "days").format(r._inputDateFormat)) : "prev" === t && (e = e.subtract(7, "days").format(r._inputDateFormat), o = o.subtract(7, "days").format(r._inputDateFormat)), r.filterParams.start_date = e, r.filterParams.end_date = o, w(y), n.appTable({
                            reload: !0,
                            filterParams: r.filterParams
                        })
                    }), y.datepicker({
                        ...
                        var t = d(a.date);
                        r.filterParams.start_date = t.firstDateOfWeek, r.filterParams.end_date = t.lastDateOfWeek, w(y), n.appTable({
                            reload: !0,
                            filterParams: r.filterParams
                        })
                    })
            ...
            if ("undefined" != typeof r.checkBoxes[0]) {
                var P = "",
                    C = [],
                    M = "";
                a.each(r.checkBoxes, function(a, t) {
                    var e = "",
                        n = "";
                    M = t.name, t.isChecked && (e = " checked", n = " active", C.push(t.value)), P += '<label class="btn btn-default ' + n + '">', P += '<input type="checkbox" name="' + t.name + '" value="' + t.value + '" autocomplete="off" ' + e + ">" + t.text, P += "</label>"
                }), r.filterParams[M] = C;
                var k = '<div class="mr15 DTTT_container"><div class="btn-group filter" data-act="checkbox" data-toggle="buttons">' + P + "</div></div>";
                v.find(".custom-toolbar").append(k);
                var S = v.find("[data-act='checkbox']");
                S.click(function() {
                    var t = a(this);
                    setTimeout(function() {
                        var e = [],
                        ...
                        t.parent().find("input:checkbox").each(function() {
                            o = a(this).attr("name"), a(this).is(":checked") && e.push(a(this).val())
                        }), r.filterParams[o] = e, n.appTable({
                            reload: !0,
                            filterParams: r.filterParams
                        })
                    })
            ...
            if ("undefined" != typeof r.radioButtons[0]) {
                var Y = "";
                a.each(r.radioButtons, function(a, t) {
                    var e = "",
                        n = "";
                    t.isChecked && (e = " checked", n = " active", r.filterParams[t.name] = t.value), Y += '<label class="btn btn-default ' + n + '">', Y += '<input type="radio" name="' + t.name + '" value="' + t.value + '" autocomplete="off" ' + e + ">" + t.text, Y += "</label>"
                });
                var j = '<div class="mr15 DTTT_container"><div class="btn-group filter" data-act="radio" data-toggle="buttons">' + Y + "</div></div>";
                v.find(".custom-toolbar").append(j);
                var A = v.find("[data-act='radio']");
                A.click(function() {
                    var t = a(this);
                    setTimeout(function() {
                        t.parent().find("input:radio").each(function() {
                            a(this).is(":checked") && (r.filterParams[a(this).attr("name")] = a(this).val())
                        }), n.appTable({
                            reload: !0,
                            filterParams: r.filterParams
                        })
            ...
            if ("undefined" != typeof r.filterDropdown[0]) {
                var Y = "";
                a.each(r.filterDropdown, function(t, e) {
                    var o = "",
                        i = "";
                    a.each(e.options, function(a, t) {
                        var e = "";
                        t.isSelected && (e = "selected", i = t.id), o += "<option " + e + " value=" + t.id + ">" + t.text + "</option>"
                    }), e.name && (r.filterParams[e.name] = i);
                    var s = '<div class="mr15 DTTT_container"><select class="' + e["class"] + '" name="' + e.name + '">' + o + "</select></div>";
                    v.find(".custom-toolbar").append(s);
                    var l = v.find("[name='" + e.name + "']");
                    void 0 !== window.Select2 && l.select2(), l.change(function() {
                        var t = a(this);
                        r.filterParams[t.attr("name")] = t.val(), n.appTable({
                            reload: !0,
                            filterParams: r.filterParams
                        })
                    })
            ...
            var $ = function(t) {
                    a('<a class="undo-delete" href="javascript:;"><strong>Undo</strong></a>').insertAfter(a(t.alertSelector).find(".app-alert-message")), a(t.alertSelector).find(".undo-delete").bind("click", function() {
                        a(t.alertSelector).remove(), appLoader.show(), a.ajax({
                            ...
                            success: function(a) {
                                appLoader.hide(), a.success && (n.appTable({
                                    newData: a.data
                                }), r.onUndoSuccess(a))
                            }
                        })
            ...
            window.InstanceCollection = window.InstanceCollection || {}, window.InstanceCollection["#" + this.id] = r, a("body").find(n).on("click", "[data-action=delete]", F), a.fn.dataTableExt.oApi.getSettings = function(a) {
                return a
    ...
    function(a) {
        ...
        return a = a.toString(), a && (a = a.replace(/[^0-9.,]/g, ""), "," === AppHelper.settings.decimalSeparator ? (a = replaceAllString(a, ".", ""), a = replaceAllString(a, ",", ".")) : a = replaceAllString(a, ",", ""), a = 1 * a), a ? a : 0
